 ...
 *
 * Disassembly of iASLI7hXpL.aml, Wed Mar 31 23:05:38 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001EDC6 (126406)
 *     Revision         0x02
 *     Checksum         0xE4
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (P0WK, FieldUnitObj)    // (from opcode)
    External (P1GP, FieldUnitObj)    // (from opcode)
    External (P1WK, FieldUnitObj)    // (from opcode)
    External (P2GP, FieldUnitObj)    // (from opcode)
    External (P2WK, FieldUnitObj)    // (from opcode)
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x87F76698, 0x0635)
    ...
    OperationRegion (OGNS, SystemMemory, 0x87F75F98, 0x0C)
    ...
    Scope (_SB)
    {
        ...
        Method (INUM, 1, NotSerialized)
        {
            ...
            {
                Add (Local1, DerefOf (Index (DerefOf (Index (GPPG, Local0)), Local3)), Local1)
                Increment (Local3)
            }
        ...
        Method (GADR, 2, NotSerialized)
        {
            ...
            Add (DerefOf (Index (DerefOf (Index (GCOM, Local0)), Arg0)), SBRG, Local1)
        ...
        Method (GPC0, 1, Serialized)
        {
            Store (GGRP (Arg0), Local0)
            Store (GNMB (Arg0), Local1)
            Add (GADR (Local0, PCFG), Multiply (Local1, 0x08), Local2)
        ...
        Method (GPC1, 1, Serialized)
        {
            Store (GGRP (Arg0), Local0)
            Store (GNMB (Arg0), Local1)
            Add (Add (GADR (Local0, PCFG), Multiply (Local1, 0x08)), 0x04, Local2)
        ...
        Method (GGPO, 1, Serialized)
        {
            Store (GGRP (Arg0), Local0)
            Store (GNMB (Arg0), Local1)
            Add (GADR (Local0, POWN), Multiply (ShiftRight (Local1, 0x03), 0x04), Local2)
        ...
        Method (UIPI, 1, Serialized)
        {
            ...
            And (ShiftRight (DerefOf (Index (RXEV, Local0)), Multiply (Local1, 0x02)), 0x03, Local3)
    ...
    Scope (\)
    {
        ...
        Method (PMBS, 0, NotSerialized)
        {
            If (LEqual (PMBV, Zero))
            {
                ShiftLeft (\_SB.PCI0.PPMC.ACBA, 0x08, PMBV)
            }
        ...
        Method (PWRM, 0, NotSerialized)
        {
            If (LEqual (PWRV, Zero))
            {
                ShiftLeft (\_SB.PCI0.PPMC.PWBA, 0x0C, PWRV)
            }
        ...
        Method (TCBS, 0, NotSerialized)
        {
            If (LEqual (TCBV, Zero))
            {
                ShiftLeft (\_SB.PCI0.SBUS.TCOB, 0x05, TCBV)
            }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC0)
        {
                ...
                Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                {
                    If (LEqual (ECON, One))
                    {
                        If (LEqual (Acquire (LFCM, 0xA000), Zero))
                        {
                            ...
                            If (B1B2 (B2FC, B3FC))
                            {
                                Divide (Multiply (B1B2 (B2FC, B3FC), 0x0A), 0x0A, , Index (PBIF, 0x05))
                                Divide (Multiply (B1B2 (B2FC, B3FC), 0x0A), 0x19, , Index (PBIF, 0x06))
                                Divide (Multiply (B1B2 (B2DC, B3DC), 0x0A), 0x64, , Index (PBIF, 0x07))
                            }
                    ...
                    If (LEqual (ECON, One))
                    {
                        If (LEqual (Acquire (LFCM, 0xA000), Zero))
                        {
                            ...
                            Switch (And (Local0, 0x07))
                            {
                                Case (Zero)
                                {
                                    And (Local1, 0xF8, OBST)
                                }
                                Case (One)
                                {
                                    Or (One, And (Local1, 0xF8), OBST)
                                }
                                Case (0x02)
                                {
                                    Or (0x02, And (Local1, 0xF8), OBST)
                                }
                                Case (0x04)
                                {
                                    Or (0x04, And (Local1, 0xF8), OBST)
                                }
                            ...
                            Divide (Multiply (OBAC, OBPV), 0x03E8, , OBPR)
                        ...
                        If (LEqual (Acquire (LFCM, 0xA000), Zero))
                        {
                            If (LEqual (Arg0, Zero))
                            {
                                ...
                                If (LGreater (VBFC, VBRC))
                                {
                                    ...
                                    Multiply (VBAC, VBPV, Local1)
                                    Multiply (Local0, 0x03E8, Local3)
                                    Multiply (Local3, 0x3C, Local3)
                                    Divide (Local3, Local1, , VBCT)
                                    Release (LFCM)
                                    Return (VBCT)
                                }
                                Else
                        ...
                        If (LEqual (Acquire (LFCM, 0xA000), Zero))
                        {
                            If (LEqual (Arg0, Zero))
                            {
                                ...
                                If (LGreater (QBFC, QBRC))
                                {
                                    ...
                                    Else
                                    {
                                        Subtract (0xFFFF, B1B2 (B2AC, B3AC), QBAC)
                                    }

                                    Multiply (QBAC, QBPV, Local1)
                                    Multiply (Local0, 0x03E8, Local3)
                                    Multiply (Local3, 0x3C, Local3)
                                    Divide (Local3, Local1, , QBCT)
                                    Release (LFCM)
                                    Return (QBCT)
                                }
                                Else
            ...
            Scope (\)
            {
                OperationRegion (LFCN, SystemMemory, 0x85F31D98, 0xE7)
                ...
                Method (BATD, 2, NotSerialized)
                {
                    ...
                    If (LEqual (Arg0, Zero))
                    {
                        ...
                        If (LEqual (Arg1, 0x02))
                        {
                            ...
                            Store (0x05, Local3)
                            ShiftRight (And (Local0, 0x01E0), 0x05, Local1)
                            While (Local1)
                            {
                                Divide (Local1, 0x0A, Local2, Local1)
                                Add (Local2, 0x30, Index (DATB, Local3))
                            ...
                            Store (0x03, Local3)
                            Add (ShiftRight (And (Local0, 0xFE00), 0x09), 0x07BC, Local1)
                            While (Local1)
                            {
                                Divide (Local1, 0x0A, Local2, Local1)
                                Add (Local2, 0x30, Index (DATB, Local3))
            ...
            Scope (\_SB)
            {
                Device (GZFD)
                {
                    ...
                    Method (WMAA, 3, NotSerialized)
                    {
                        ...
                        If (LEqual (Arg1, 0x14))
                        {
                            And (^^PCI0.LPCB.EC0.GDST, One, Local0)
                            If (LEqual (Local0, One))
                            {
                                Return (One)
                            }
                        ...
                        {
                            Store (0x23, P80H)
                            And (^^PCI0.LPCB.EC0.GDST, 0x02, Local0)
                            If (LEqual (Local0, 0x02))
                            {
                                Return (One)
                            }
                        ...
                        {
                            Store (0x26, P80H)
                            And (^^PCI0.LPCB.EC0.GDST, 0x04, Local0)
                    ...
                    Method (_WED, 1, NotSerialized)  // _Wxx: Wake Event
                    {
                        ...
                        If (LEqual (Arg0, 0xE1))
                        {
                            If (LAnd (^^PCI0.LPCB.EC0.GDST, 0x10))
                            {
                                Return (One)
                            }
                            Else
                        ...
                        If (LEqual (Arg0, 0xE2))
                        {
                            Store (0xE2, P80H)
                            Store (Zero, Local0)
                            And (^^PCI0.LPCB.EC0.GDST, 0x02, Local1)
                            If (LEqual (Local1, 0x02))
                            {
                                Or (Local0, One, Local0)
                            }

                            And (^^PCI0.LPCB.EC0.GDST, 0x04, Local1)
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04))){}
        If (LAnd (\_SB.PCI0.LPCB.EC0.GDST, 0x04))
        {
    ...
    OperationRegion (MDBG, SystemMemory, 0x87F5E018, 0x1004)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Method (PINR, 2, Serialized)
        {
            ...
            Add (Multiply (0x18, Arg1), Arg0, PINF)
            Return (GPIR)
        }
    ...
    OperationRegion (LGNS, SystemMemory, 0x87F5D000, 0x05)
